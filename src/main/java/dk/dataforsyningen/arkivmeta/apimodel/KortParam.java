...
public class KortParam
{
    ...
    public KortParam(List<String> arketype, List<String> daekningsomraade, String direction,
                     ...
                     String kortbladnummer, List<String> kortvaerk, List<String> maalestok, int offset, int pagesize,
    ...
    public int hashCode()
    {
        return Objects.hash(arketype, daekningsomraade, direction, fritekstsoegning, gaeldendefra, gaeldendetil,
