...
public class MatrikelkortDto extends KortDto
{
    ...
    public MatrikelkortDto(String id, String alternativtitel, String arketype, String bemaerkning,
                           ...
                           Integer gaeldendetil, String geometri, String kortbladnummer, String kortvaerk,
                           String maalestok, String originalkortprojektion, String originalehjoernekoordinater,
                           LocalDateTime registreringfra, LocalDateTime registreringtil, String titel,
                           String uniktkortnavn, Integer aarforkortproeve, Integer aarforopmaalingsluttet,
                           Integer aarforudskiftning, String kortart, String kortdimensioner, String opmaaltaf,
                           String plannr, Long rytterdistriktid, String udskiftetaf)
    {
        super(id, alternativtitel, arketype, bemaerkning, daekningsomraade, filer, gaeldendefra, gaeldendetil, geometri,
